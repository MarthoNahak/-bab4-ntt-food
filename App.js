    ...
    <View style={styles.container}>
      ...
      <View style={styles.listCategory}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          ...
          <View style={category.item}>
            <Text style={category.title}>Kategory</Text>
          </View>
          <View style={category.item}>
            <Text style={category.title}>Favorit</Text>
          </View>
          <View style={category.item}>
            <Text style={category.title}>menu</Text>
          </View>
        ...
        <ScrollView
          ...
          <View style={{...itemHorizontal.cardItem, marginLeft: 24}}>
            <ImageBackground
              ...
              source={{
                uri: 'https://merahputih.com/media/6d/e7/7f/6de77f771c2edb74bc2960ced9436a9e.jpg',
              }}>
              <View style={itemHorizontal.cardContent}>
                <View style={itemHorizontal.cardInfo}>
                  <Text style={itemHorizontal.cardTitle}>
                    Promo Cashback
                        Tiap Pembelian Paket
                  </Text>
          ...
          <View style={itemHorizontal.cardItem}>
            <ImageBackground
              ...
              imageStyle={{borderRadius: 15}}
              source={{
                uri: 'https://www.nativeindonesia.com/foto/2020/02/Sambal-Ikan-Teri-1.jpg',
              }}>
              <View style={itemHorizontal.cardContent}>
                <View style={itemHorizontal.cardInfo}>
                  <Text style={itemHorizontal.cardTitle}>
        ...
        <View style={itemVertical.listCard}>
          <View style={itemVertical.cardItem}>
            <Image
              ...
              source={{
                uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxII1-i8Lj8jR4OBjjjVYIlEcmWwDngVUyIg&usqp=CAU',
              }}
            />
            <View style={itemVertical.cardContent}>
              <View
                ...
                <View style={{gap: 5, width: '70%'}}>
                  <Text style={itemVertical.cardCategory}>Favorit</Text>
                  <Text style={itemVertical.cardTitle}>
                  Se’i Khas NTT Asap Wangi Aroma Asli Kupang Babi Pork Kuliner Indonesia Timur Flores
                  </Text>
                </View>
                <Receipt21
          ...
          <View style={itemVertical.cardItem}>
            <Image
              style={itemVertical.cardImage}
              source={{
                uri: 'https://asset-a.grid.id/crop/0x0:0x0/x/photo/2018/08/26/2031689006.jpg',
              }}
            />
            <View style={itemVertical.cardContent}>
              <View
                ...
                <View style={{gap: 5, width: '70%'}}>
                  ...
                  <Text style={itemVertical.cardTitle}>
                  Jagung Bose, Kuliner Khas Nusa Tenggara Timur yang Cocok Disantap di Akhir Pekan
                  </Text>
                </View>
                <Receipt21
                  color={colors.grey(0.6)}
          ...
          <View style={itemVertical.cardItem}>
            <Image
              style={itemVertical.cardImage}
              source={{
                uri: 'https://www.nativeindonesia.com/foto/2020/02/Ikan-Kuah-Belimbing-Wuluh.jpg',
              }}
            />
            <View style={itemVertical.cardContent}>
              <View
                ...
                <View style={{gap: 5, width: '70%'}}>
                  <Text style={itemVertical.cardCategory}>Populer</Text>
                  <Text style={itemVertical.cardTitle}>Ikan Kuah Belimbing</Text>
                </View>
                <Receipt21
                  color={colors.grey(0.6)}
                  variant="Linear"
